...
import { useLocations, Bounds } from '../hooks/useLocations';
...
const styles = StyleSheet.create({
  ...
  emptyGlyph: { fontSize: 20, color: Colors.amberDim, marginBottom: 12 },
  emptyTitle: {
    fontFamily: Fonts.displaySemiBold, fontSize: 18,
    color: Colors.textSecondary, marginBottom: 8, textAlign: 'center',
  },
  emptyBody: {
    fontFamily: Fonts.display, fontSize: 14,
    color: Colors.textMuted, textAlign: 'center', lineHeight: 21, marginBottom: 18,
  },
  emptyBtn: { borderWidth: 1, borderColor: Colors.amber, paddingHorizontal: 16, paddingVertical: 9 },
  emptyBtnText: { fontFamily: Fonts.uiBold, fontSize: 10, color: Colors.amber, letterSpacing: 1.3 },
  ...
  introSymbol: {
    fontFamily: Fonts.uiBold, fontSize: 26,
    color: Colors.amberDim, letterSpacing: 6, marginBottom: 20,
  },
  introEyebrow: {
    fontFamily: Fonts.uiBold, fontSize: 8.5,
    color: Colors.amberDim, letterSpacing: 2.8, marginBottom: 14,
  },
  introTitle: {
    fontFamily: Fonts.displaySemiBold, fontSize: 70,
    color: Colors.textPrimary, lineHeight: 72, textAlign: 'center', letterSpacing: 1,
  },
  introSep: {
    flexDirection: 'row', alignItems: 'center',
    gap: 12, marginVertical: 28, width: '65%',
  },
  introSepLine: { flex: 1, height: 1, backgroundColor: Colors.amber + '38' },
  introSepDot: { width: 5, height: 5, borderRadius: 2.5, backgroundColor: Colors.amberDim },
  introTagline: {
    fontFamily: Fonts.displayItalic, fontSize: 17,
    color: Colors.textSecondary, textAlign: 'center', lineHeight: 26, marginBottom: 10,
  },
  introStates: {
    fontFamily: Fonts.ui, fontSize: 9,
    color: Colors.textMuted, textAlign: 'center', letterSpacing: 1.2, marginBottom: 44,
  },
  introBtn: { backgroundColor: Colors.amber, paddingHorizontal: 32, paddingVertical: 15 },
  introBtnText: { fontFamily: Fonts.uiBold, fontSize: 12, color: Colors.bg, letterSpacing: 2 },
});
